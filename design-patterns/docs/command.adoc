:root_dir: ../../
:docs_dir: ./
:src_dir: ../src/net/razy/design/patterns/behavioral/command
...
[source,java]
----
include::{src_dir}/Command.java[]
----

.AbstractCommand
[source,java]
----
include::{src_dir}/AbstractCommand.java[]
----

.TurnOnCommander
[source,java]
----
include::{src_dir}/TurnOnCommander.java[]
----

.TurnOffCommander
[source,java]
----
include::{src_dir}/TurnOffCommander.java[]
----
