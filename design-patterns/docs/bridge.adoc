:root_dir: ../../
:docs_dir: ./
:src_dir: ../src/net/razy/design/patterns/structural/bridge
...
[source,java]
----
include::{src_dir}/AbstractAbstraction.java[]
----
...
[source,java]
----
include::{src_dir}/EagleAbstraction.java[]
----
...
[source,java]
----
include::{src_dir}/WolfAbstraction.java[]
----
...
[source,java]
----
include::{src_dir}/MammalImplementor.java[]
----
...
[source,java]
----
include::{src_dir}/BirdImplementor.java[]
----
