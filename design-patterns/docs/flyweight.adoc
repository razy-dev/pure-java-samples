:root_dir: ../../
:docs_dir: ./
:src_dir: ../src/net/razy/design/patterns/structural/flyweight
...
[source,java]
----
include::{src_dir}/Flyweight.java[]
----

.ConcreteFlyweight
[source,java]
----
include::{src_dir}/ConcreteFlyweight.java[]
----
...
[source,java]
----
include::{src_dir}/FlyweightFactory.java[]
----
