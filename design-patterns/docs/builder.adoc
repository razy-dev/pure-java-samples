:root_dir: ../../
:docs_dir: ./
:src_dir: ../src/net/razy/design/patterns/creational/builder
...
[source,java]
----
include::{src_dir}/ProductBuilder.java[]
----
...
[source,java]
----
include::{src_dir}/AbstractBuilder.java[]
----

.BlueProductBuilder
[source,java]
----
include::{src_dir}/BlueProductBuilder.java[]
----

.GreenProductBuilder
[source,java]
----
include::{src_dir}/GreenProductBuilder.java[]
----
